            ...
            bool isHatches, TransitionData transitionData)
        {
            ...
            switch (NameGost, ConnectionType, ShapePreparedEdgesPart1, ShapePreparedEdgesPart2)
            {
                case ("5264-80" or "8713-79" or "14771-76", ConnectionTypeEnum.Стыковое, ShapePreparedEdgesEnum.Без_скоса_стыковое, ShapePreparedEdgesEnum.Без_скоса_стыковое):
                    ...
                    {                       
                        case (TransitionTypeEnum.Без_перехода, TransitionTypeEnum.Без_перехода):
                            switch (locationPart)
                            {
                                case LocationPart.Лево_Верх or LocationPart.Лево_Низ or LocationPart.Право_Верх or LocationPart.Право_Низ:
                                    {
                                        ...
                                        if(locationPart == LocationPart.Лево_Верх || locationPart == LocationPart.Лево_Низ)
                                        {
                                        ...
                                        if (drawDimensions)
                                        {
                                            ...
                                            LineDimension(lineDimensions, -paramBManual / 2 - extraLength, ldThicknessR.Y1, -paramBManual / 2 - extraLength, ldThicknessR.Y2,
                                ...
                                case LocationPart.Верх_Лево or LocationPart.Верх_Право or LocationPart.Низ_Лево or LocationPart.Низ_Право:
                                    {
                                        ...
                                        DrawingPart(view, thickness, locationPart, true, false,
                                                    gapDimToPart, gapDimToDim, gapDimToPartLeft, extraLength, isCrossSection, isHatches, transitionData);
                                        //Что бы не плодить код, делаю поправку смещения группы тут.
                                        if(locationPart == LocationPart.Верх_Лево || locationPart == LocationPart.Верх_Право)
                                        {
                                        ...
                                        if (drawDimensions)
                                        {
                                            ...
                                            LineDimension(lineDimensions, ldThicknessR.X1, paramBManual / 2 + extraLength, ldThicknessR.X2, paramBManual / 2 + extraLength,
                                ...
                                case LocationPart.Право_Верх or LocationPart.Право_Низ or LocationPart.Лево_Верх or LocationPart.Лево_Низ:
                                    {
                                        ...
                                        if (drawDimensions)
                                        {
                                            ...
                                            ILineDimension ldParamCL = LineDimension(lineDimensions, -paramBManual / 2, -ParamC / 2, -paramBManual / 2, ParamC / 2,
                                                -xangle - extraLength - gapDimToPart - paramBManual / 2, 0, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            ...
                                            ILineDimension ldParamCR = LineDimension(lineDimensions, paramBManual / 2, -ParamC / 2, paramBManual / 2, ParamC / 2,
                                                xangle + extraLength + gapDimToPart * 2 + paramBManual / 2, 0, ksLineDimensionOrientationEnum.ksLinDVertical);
                                ...
                                case LocationPart.Верх_Лево or LocationPart.Верх_Право or LocationPart.Низ_Лево or LocationPart.Низ_Право:
                                    {
                                        ...
                                        if (drawDimensions)
                                        {
                                            ...
                                            ILineDimension ldParamCH = LineDimension(lineDimensions, ParamC / 2, paramBManual / 2, -ParamC / 2, paramBManual / 2,
                                                0, xangle + extraLength + gapDimToPart + paramBManual / 2, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                            ...
                                            ILineDimension ldParamCD = LineDimension(lineDimensions, ParamC / 2, -paramBManual / 2, -ParamC / 2, -paramBManual / 2,
                                                0, -xangle - extraLength - gapDimToPart * 2 - paramBManual / 2, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                ...
                                case LocationPart.Лево_Верх or LocationPart.Лево_Низ:
                                    {
                                        ...
                                        if (drawDimensions)
                                        {
                                            ...
                                            ILineDimension ldParamCL = LineDimension(lineDimensions,
                                                ...
                                                -paramBManual / 2, ParamC / 2,
                                                -paramBManual / 2 - transitionData.DimL - extraLength - gapDimToPart, 0, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            SetDeviation((IDimensionText)ldParamCL, paramCTolerance);
                                            ...
                                            ldParamAHR.Update();
                                            //Толщина в стыке
                                            ILineDimension ldThicknessL = LineDimension(lineDimensions, -paramBManual / 2 - xangle, thickness / 2, -paramBManual / 2 - xangle, -thickness / 2,
                                                ldParamAHL.X3 - gapDimToDim, 0, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            //Если верхний и нижний допуск притупления одинаков то расстояние до детали меньше чем при разных допусках
                                            if (Math.Abs(ParamCTolerance[0]) != Math.Abs(ParamCTolerance[1]))
                                            {
                                                ldThicknessL.X3 = ldParamCL.X3 - gapDimToDim * 1.5;
                                            ...
                                            //Линейный вертикальный толщины
                                            LineDimension(lineDimensions, -paramBManual / 2 - transitionData.DimL - extraLength, thickness / 2 + transitionData.DimH, -paramBManual / 2 - transitionData.DimL - extraLength, -thickness / 2 - transitionData.DimH,
                                                ldThicknessL.X3 - gapDimToDim, 0, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            ILineDimension ldThicknessR = LineDimension(lineDimensions, paramBManual / 2 + xangle + extraLength, thickness / 2, paramBManual / 2 + xangle + extraLength, -thickness / 2,
                                                ldParamCR.X3 + gapDimToDim, 0, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            SetDeviation((IDimensionText)ldParamCR, paramCTolerance);
                                ...
                                case LocationPart.Право_Верх or LocationPart.Право_Низ:
                                    {
                                        ...
                                        if (drawDimensions)
                                        {
                                            ...
                                            ILineDimension ldParamCL = LineDimension(lineDimensions,
                                                -paramBManual / 2, -ParamC / 2,
                                                -paramBManual / 2, ParamC / 2,
                                                -paramBManual / 2 - xangle - extraLength - gapDimToPart, 0, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            SetDeviation((IDimensionText)ldParamCL, paramCTolerance);
                                            ILineDimension ldParamCR = LineDimension(lineDimensions,
                                                paramBManual / 2, -ParamC / 2,
                                                paramBManual / 2, ParamC / 2,
                                ...
                                case LocationPart.Низ_Лево or LocationPart.Низ_Право:
                                    {
                                        ...
                                        if (drawDimensions)
                                        {
                                            ...
                                            extraLength = extraLength < 1 ? 1 : extraLength;
                                            //Линейный вертикальный угла
                                            ILineDimension ldParamA = LineDimension(lineDimensions,
                                                -thickness / 2, -xangle - paramBManual / 2,
                                                -ParamC / 2, -paramBManual / 2,
                                                -thickness / 2 - gapDimToPart, -xangle / 2 - paramBManual / 2, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            LineDimension(lineDimensions,
                                                ldParamA.X1, -ldParamA.Y1,
                                                ldParamA.X2, -ldParamA.Y2,
                                                ldParamA.X3, -ldParamA.Y3, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            //Линейный вертикальный зазора в стыке
                                            ILineDimension ldParamB = LineDimension(lineDimensions,
                                                -ParamC / 2, -paramBManual / 2,
                                                -ParamC / 2, paramBManual / 2,
                                            ...
                                            //Линейный горизонтальный притупления
                                            ILineDimension ldParamCH = LineDimension(lineDimensions,
                                                ParamC / 2, paramBManual / 2,
                                                -ParamC / 2, paramBManual / 2,
                                                0, xangle + extraLength + gapDimToPart + paramBManual / 2, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                            SetDeviation((IDimensionText)ldParamCH, paramCTolerance);
                                            ILineDimension ldParamCD = LineDimension(lineDimensions,
                                                ldParamCH.X1, -ldParamCH.Y1,
                                                ldParamCH.X2, -ldParamCH.Y2,
                                                0, -paramBManual / 2 - transitionData.DimL - extraLength - gapDimToPart * 2 , ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                            SetDeviation((IDimensionText)ldParamCD, paramCTolerance);
                                            if (Math.Abs(ParamCTolerance[0]) != Math.Abs(ParamCTolerance[1]))
                                            {
                                                ldParamCD.Y3 -= gapDimToPart;
                                                ldParamCD.Update();
                                            }
                                            //Линейный горизонтальный угла
                                            ILineDimension ldParamAHH = LineDimension(lineDimensions,
                                                -thickness / 2, paramBManual / 2 + xangle + extraLength,
                                                -ParamC / 2, paramBManual / 2,
                                                -(thickness + ParamC) / 4, ldParamCH.Y3, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                            ((IDimensionText)ldParamAHH).Accuracy = ksAccuracyEnum.ksAccuracy1;
                                            ldParamAHH.Update();
                                            ILineDimension ldParamAHD = LineDimension(lineDimensions,
                                                -thickness / 2, -paramBManual / 2 - xangle,
                                                -ParamC / 2, -paramBManual / 2,
                                                -(thickness + ParamC) / 4, ldParamCD.Y3, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                            ((IDimensionText)ldParamAHD).Accuracy = ksAccuracyEnum.ksAccuracy1;
                                            ldParamAHD.Update();
                                            //Линейный горизонтальный толщины верхний
                                            ILineDimension ldThicknessH = LineDimension(lineDimensions,
                                                -thickness / 2, paramBManual / 2 + xangle + extraLength,
                                                thickness / 2, paramBManual / 2 + xangle + extraLength,
                                                0, ldParamCH.Y3 + gapDimToDim, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                            //Если верхний и нижний допуск притупления одинаков то расстояние до детали меньше чем при разных допусках
                                ...
                                case LocationPart.Лево_Верх or LocationPart.Лево_Низ:
                                    {
                                        ...
                                        if (drawDimensions)
                                        {
                                            ...
                                            //Линейный вертикальный перехода
                                            ILineDimension ldD = LineDimension(lineDimensions, ls2.X2, ls2.Y2, ls2.X1, ls2.Y1, gapDimToPart * 2, ls2.Y1 - transitionData.DimH / 2, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            ((IDimensionText)ldD).Accuracy = ksAccuracyEnum.ksAccuracy1;
                                            ldD.Update();
                                            ILineDimension ldH = LineDimension(lineDimensions, ls4.X2, ls4.Y2, ls4.X1, ls4.Y1, ldD.X3, -ldD.Y3, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            ((IDimensionText)ldH).Accuracy = ksAccuracyEnum.ksAccuracy1;
                                            ldH.Update();
                                            //Линейный вертикальный толщины в стыке
                                            LineDimension(lineDimensions, ls1.X1, ls1.Y1, ls1.X2, ls1.Y2, ldD.X3, 0, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            //Линейный горизонтальный перехода
                                ...
                                case LocationPart.Право_Верх or LocationPart.Право_Низ:
                                    {
                                        ...
                                        if (drawDimensions)
                                        {
                                            ...
                                            //Линейный вертикальный перехода
                                            ILineDimension ldD = LineDimension(lineDimensions, ls2.X2, ls2.Y2, ls2.X1, ls2.Y1, -gapDimToPart, ls2.Y1 - transitionData.DimH / 2, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            ((IDimensionText)ldD).Accuracy = ksAccuracyEnum.ksAccuracy1;
                                            ldD.Update();
                                            ILineDimension ldH = LineDimension(lineDimensions, ls4.X2, ls4.Y2, ls4.X1, ls4.Y1, ldD.X3, -ldD.Y3, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            ((IDimensionText)ldH).Accuracy = ksAccuracyEnum.ksAccuracy1;
                                ...
                                case LocationPart.Верх_Лево or LocationPart.Верх_Право:
                                    {
                                        ...
                                        if (drawDimensions)
                                        {
                                            ...
                                            //Линейный горизонтальный перехода
                                            ILineDimension ldL = LineDimension(lineDimensions, ls2.X2, ls2.Y2, ls1.X1, ls1.Y1, ls1.X1 - transitionData.DimH / 2, -gapDimToPart * 2, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                            ((IDimensionText)ldL).Accuracy = ksAccuracyEnum.ksAccuracy1;
                                            ldL.Update();
                                            ILineDimension ldR = LineDimension(lineDimensions, ls4.X2, ls4.Y2, ls1.X2, ls1.Y2, -ldL.X3, ldL.Y3, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                            ((IDimensionText)ldR).Accuracy = ksAccuracyEnum.ksAccuracy1;
                                            ldR.Update();
                                            //Линейный горизонтальный толщины в стыке
                                            LineDimension(lineDimensions, ls1.X1, ls1.Y1, ls1.X2, ls1.Y2, 0, ldL.Y3, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                            //Линейный вертикальный перехода
                                            LineDimension(lineDimensions, ls2.X2, ls2.Y2, ls1.X2, ls1.Y2,
                                ...
                                case LocationPart.Низ_Лево or LocationPart.Низ_Право:
                                    {
                                        ...
                                        if (drawDimensions)
                                        {
                                            ...
                                            //Линейный горизонтальный перехода
                                            ILineDimension ldL = LineDimension(lineDimensions, ls2.X2, ls2.Y2, ls1.X1, ls1.Y1, ls1.X1 - transitionData.DimH / 2, gapDimToPart, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                            ((IDimensionText)ldL).Accuracy = ksAccuracyEnum.ksAccuracy1;
                                            ldL.Update();
                                            ILineDimension ldR = LineDimension(lineDimensions, ls4.X2, ls4.Y2, ls1.X2, ls1.Y2, -ldL.X3, ldL.Y3, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                            ((IDimensionText)ldR).Accuracy = ksAccuracyEnum.ksAccuracy1;
                                ...
                                case LocationPart.Лево_Верх:
                                    {
                                        ...
                                        //Создаём основу разделки
                                        //Притупление
                                        ILineSegment lsParamC = DrawLineSegment(lineSegments, 0, 0, 0, ParamC);
                                        //Угла
                                        ILineSegment lsAngle = DrawLineSegment(lineSegments, lsParamC.X2, lsParamC.Y2, -xangle, thickness);
                                        //Переход от угла
                                        ILineSegment lsTransitionAngle = DrawLineSegment(lineSegments, lsAngle.X2, lsAngle.Y2, -transitionData.DimL, lsAngle.Y2 + transitionData.DimH);
                                        //От перехода к краю детали
                                        ILineSegment lsExtraTransition = DrawLineSegment(lineSegments, lsTransitionAngle.X2, lsTransitionAngle.Y2, lsTransitionAngle.X2 - extraLength, lsTransitionAngle.Y2);
                                        //Переход от нуля
                                        ILineSegment lsTransition0= DrawLineSegment(lineSegments, 0, 0, lsTransitionAngle.X2, -transitionData.DimH);
                                        //От перехода к краю детали
                                        ILineSegment lsExtraTransition0 = DrawLineSegment(lineSegments, lsTransition0.X2, lsTransition0.Y2, lsExtraTransition.X2, lsTransition0.Y2);
                                        //Волнистая линия
                                        IWaveLines waveLines = symbols2DContainer.WaveLines;
                                        IWaveLine waveLine = waveLines.Add();
                                        waveLine.X1 = lsExtraTransition0.X2;
                                        waveLine.Y1 = lsExtraTransition0.Y2;
                                        waveLine.X2 = lsExtraTransition.X2;
                                        waveLine.Y2 = lsExtraTransition.Y2;
                                        waveLine.Style = (int)ksCurveStyleEnum.ksCSBrokenLine;
                                        waveLine.Update();
                                        if (isHatches)
                                        {
                                            ...
                                            IContour contour = (IContour)drawingContour;
                                            //Добавляем в контур элементы которые ограничивают штриховку
                                            contour.CopySegments(lsParamC, false);
                                        ...
                                        if (!isCrossSection)
                                        {
                                            DrawLineSegment(lineSegments, lsTransition0.X2, lsTransition0.Y2, paramBManual, lsTransition0.Y2);
                                            DrawLineSegment(lineSegments, paramBManual, lsTransition0.Y2, paramBManual, lsTransitionAngle.Y2);
                                            DrawLineSegment(lineSegments, paramBManual, lsTransitionAngle.Y2, lsTransitionAngle.X2, lsTransitionAngle.Y2);
                                        }
                                        //Чертим размеры
                                        if (drawDimensions)
                                        {
                                            //Линейный вертикальный толщины
                                            ILineDimension ldThickness = LineDimension(lineDimensions, lsExtraTransition0.X2, lsExtraTransition0.Y2, lsExtraTransition.X2, lsExtraTransition.Y2,
                                                lsExtraTransition.X2 - gapDimToPart, thickness / 2, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            //Линейный горизонтальный угла
                                            ILineDimension ldParamA = LineDimension(lineDimensions, lsAngle.X2, lsAngle.Y2, lsAngle.X1, lsAngle.Y1, lsAngle.X2 / 2, lsTransitionAngle.Y2 + gapDimToPart,
                                                ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                            //Линейный вертикальный притупления
                                            ILineDimension ldParamC = LineDimension(lineDimensions, lsParamC.X2, lsParamC.Y2, lsParamC.X1, lsParamC.Y1, gapDimToPart * 2, lsParamC.Y2 / 2,
                                                ksLineDimensionOrientationEnum.ksLinDVertical);
                                            SetDeviation((IDimensionText)ldParamC, paramCTolerance);
                                            //Если верхний и нижний допуск на притупление одинаков то расстояние до детали меньше чем при разных допусках
                                            if (Math.Abs(ParamCTolerance[0]) != Math.Abs(ParamCTolerance[1]))
                                            ...
                                            {
                                                //Зазора в стыке
                                                ILineDimension ldParamB = LineDimension(lineDimensions, paramBManual, lsTransitionAngle.Y2, lsParamC.X2, lsParamC.Y2, paramBManual / 2, ldParamA.Y3,
                                                ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                                SetDeviation((IDimensionText)ldParamB, paramBTolerance);
                                                //Двигаем размер притупления на величину зазора если выбран разрез
                                                ldParamC.X3 += paramBManual;
                                                ldParamC.Update();
                                                //Если зазор в стыке равен нулю приходится для наглядности сделать его равным двум милиметрам
                                                //При это в размер забиваем вручную ноль
                                                if (ParamB == 0)
                                            ...
                                            //Линейный горизонтальный перехода
                                            LineDimension(lineDimensions, lsTransitionAngle.X2, lsTransitionAngle.Y2, 0, 0,
                                                lsTransition0.X2 / 2, lsTransition0.Y2 - gapDimToPart * 2, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                            //Линейный вертикальный толщины в стыке
                                            ILineDimension ldThicknessJoint = LineDimension(lineDimensions, 0, 0, lsAngle.X2, lsAngle.Y2,
                                                ldParamC.X3 + gapDimToDim, ldThickness.Y3, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            //Линейный вертикальный перехода
                                            ILineDimension ldTransitionD = LineDimension(lineDimensions, lsTransition0.X2, lsTransition0.Y2, 0, 0,
                                                ldThicknessJoint.X3, -transitionData.DimH / 2, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            ((IDimensionText)ldTransitionD).Accuracy = ksAccuracyEnum.ksAccuracy1;
                                            ldTransitionD.Update();
                                            ILineDimension ldTransitionU = LineDimension(lineDimensions, lsTransitionAngle.X2, lsTransitionAngle.Y2, lsTransitionAngle.X1, lsTransitionAngle.Y1,
                                                ldThicknessJoint.X3, lsAngle.Y2 + transitionData.DimH / 2, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            ((IDimensionText)ldTransitionU).Accuracy = ksAccuracyEnum.ksAccuracy1;
                                            ldTransitionU.Update();
                                ...
                                case LocationPart.Лево_Низ:
                                    {
                                        ...
                                        if (drawDimensions)
                                        {
                                            ...
                                            ILineDimension ldThickness = LineDimension(lineDimensions, lsExtraTransition0.X2, lsExtraTransition0.Y2, lsExtraTransition.X2, lsExtraTransition.Y2,
                                                lsExtraTransition.X2 - gapDimToPart, -thickness / 2, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            //Линейный горизонтальный угла
                                            ILineDimension ldParamA = LineDimension(lineDimensions, lsAngle.X2, lsAngle.Y2, lsAngle.X1, lsAngle.Y1, lsAngle.X2 / 2, lsTransitionAngle.Y2 - gapDimToPart * 2,
                                                ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                            //Линейный горизонтальный перехода
                                            ILineDimension ldTransitionH = LineDimension(lineDimensions, lsTransitionAngle.X2, lsTransitionAngle.Y2, 0, 0,
                                                lsTransition0.X2 / 2, lsTransition0.Y2 + gapDimToPart, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                            //Линейный вертикальный притупления
                                            ILineDimension ldParamC = LineDimension(lineDimensions, lsParamC.X2, lsParamC.Y2, lsParamC.X1, lsParamC.Y1, gapDimToPart * 2, lsParamC.Y2 / 2,
                                                ksLineDimensionOrientationEnum.ksLinDVertical);
                                            SetDeviation((IDimensionText)ldParamC, paramCTolerance);
                                            ...
                                            {
                                                //Зазора в стыке
                                                ILineDimension ldParamB = LineDimension(lineDimensions, paramBManual, lsTransition0.Y2, 0, 0, paramBManual / 2, ldTransitionH.Y3,
                                                ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                                SetDeviation((IDimensionText)ldParamB, paramBTolerance);
                                                //Двигаем размер притупления на величину зазора если выбран разрез
                                                ldParamC.X3 += paramBManual;
                                ...
                                case LocationPart.Право_Верх:
                                    {
                                        ...
                                        if (drawDimensions)
                                        {
                                            //Линейный вертикальный толщины
                                            ILineDimension ldThickness = LineDimension(lineDimensions, lsExtraTransition0.X2, lsExtraTransition0.Y2, lsExtraTransition.X2, lsExtraTransition.Y2,
                                                lsExtraTransition.X2 + gapDimToPart * 2, thickness / 2, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            //Линейный горизонтальный угла
                                            ILineDimension ldParamA = LineDimension(lineDimensions, lsAngle.X2, lsAngle.Y2, lsAngle.X1, lsAngle.Y1, lsAngle.X2 / 2, lsTransitionAngle.Y2 + gapDimToPart,
                                                ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                            //Линейный вертикальный притупления
                                            ILineDimension ldParamC = LineDimension(lineDimensions, lsParamC.X2, lsParamC.Y2, lsParamC.X1, lsParamC.Y1, -gapDimToPart, lsParamC.Y2 / 2,
                                                ksLineDimensionOrientationEnum.ksLinDVertical);
                                            SetDeviation((IDimensionText)ldParamC, paramCTolerance);
                                            if (!isCrossSection && paramBManual != 0)
                                            {
                                            ...
                                            if (Math.Abs(ParamCTolerance[0]) != Math.Abs(ParamCTolerance[1]))
                                            {
                                                ldThicknessJoint.X3 = ldParamC.X3 - gapDimToDim * 1.5;
                                ...
                                case LocationPart.Верх_Лево:
                                    {
                                        ...
                                        //Чертим графику
                                        //Притупление
                                        ILineSegment lsParamC = DrawLineSegment(lineSegments, 0, 0, -ParamC, 0);
                                        //Угла
                                        ILineSegment lsAngle = DrawLineSegment(lineSegments, lsParamC.X2, lsParamC.Y2, -thickness, xangle);
                                        //Переход от угла
                                        ...
                                        if (drawDimensions)
                                        {
                                            //Линейный горизонтальный толщины
                                            ILineDimension ldThickness = LineDimension(lineDimensions, lsExtraTransition0.X2, lsExtraTransition0.Y2, lsExtraTransition.X2, lsExtraTransition.Y2,
                                                -thickness / 2, lsExtraTransition.Y2 + gapDimToPart, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                            //Линейный вертикальный угла
                                            ILineDimension ldParamA = LineDimension(lineDimensions, lsAngle.X2, lsAngle.Y2, lsAngle.X1, lsAngle.Y1, lsTransitionAngle.X2 - gapDimToPart, lsAngle.Y2 / 2,
                                                ksLineDimensionOrientationEnum.ksLinDVertical);
                                            //Линейный вертикальный перехода
                                            ILineDimension ldTransitionH = LineDimension(lineDimensions, lsTransitionAngle.X2, lsTransitionAngle.Y2, 0, 0,
                                                lsTransition0.X2 + gapDimToPart * 2, lsTransition0.Y2 / 2, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            //Линейный горизонтальный притупления
                                            ILineDimension ldParamC = LineDimension(lineDimensions, lsParamC.X2, lsParamC.Y2, lsParamC.X1, lsParamC.Y1, lsParamC.X2 / 2, -gapDimToPart * 2,
                                                ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                            SetDeviation((IDimensionText)ldParamC, paramCTolerance);
                                            //Если верхний и нижний допуск на притупление одинаков то расстояние до детали меньше чем при разных допусках
                                            if (Math.Abs(ParamCTolerance[0]) != Math.Abs(ParamCTolerance[1]))
                                            ...
                                            {
                                                //Зазора в стыке
                                                ILineDimension ldParamB = LineDimension(lineDimensions, lsTransitionAngle.X2, -paramBManual, lsParamC.X2, lsParamC.Y2, ldParamA.X3, -paramBManual / 2,
                                                ksLineDimensionOrientationEnum.ksLinDVertical);
                                                SetDeviation((IDimensionText)ldParamB, paramBTolerance);
                                                //Двигаем размер притупления на величину зазора если выбран разрез
                                                ldParamC.Y3 -= paramBManual;
                                                ldParamC.Update();
                                                //Если зазор в стыке равен нулю приходится для наглядности сделать его равным двум милиметрам
                                                //При это в размер забиваем вручную ноль
                                                if (ParamB == 0)
                                            ...
                                            //Линейный горизонтальный толщины в стыке
                                            ILineDimension ldThicknessJoint = LineDimension(lineDimensions, 0, 0, lsAngle.X2, lsAngle.Y2,
                                                ldThickness.X3, ldParamC.Y3 - gapDimToDim, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                            //Линейный горизонтальный перехода
                                            ILineDimension ldTransitionD = LineDimension(lineDimensions, lsTransition0.X2, lsTransition0.Y2, 0, 0,
                                ...
                                case LocationPart.Низ_Лево:
                                    {
                                        ...
                                        if (drawDimensions)
                                        {
                                            //Линейный горизонтальный толщины
                                            ILineDimension ldThickness = LineDimension(lineDimensions, lsExtraTransition0.X2, lsExtraTransition0.Y2, lsExtraTransition.X2, lsExtraTransition.Y2,
                                                -thickness / 2, lsExtraTransition.Y2 - gapDimToPart * 2, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                            //Линейный вертикальный угла
                                            ILineDimension ldParamA = LineDimension(lineDimensions, lsAngle.X2, lsAngle.Y2, lsAngle.X1, lsAngle.Y1, lsTransitionAngle.X2 - gapDimToPart, lsAngle.Y2 / 2,
                                                ksLineDimensionOrientationEnum.ksLinDVertical);
                                            //Линейный вертикальный перехода
                                            ...
                                            if (Math.Abs(ParamCTolerance[0]) != Math.Abs(ParamCTolerance[1]))
                                            {
                                                ldThicknessJoint.Y3 = ldParamC.Y3 + gapDimToDim * 1.5;
                                                ldThicknessJoint.Update();
                                            }
                                            //Линейный горизонтальный перехода
                                            ILineDimension ldTransitionD = LineDimension(lineDimensions, lsTransition0.X2, lsTransition0.Y2, 0, 0,
                                ...
                                case LocationPart.Лево_Верх or LocationPart.Лево_Низ:
                                    {
                                        ...
                                        if (drawDimensions)
                                        {
                                            ...
                                            //Линейный вертикальный перехода
                                            ILineDimension ldVTransition1 = LineDimension(lineDimensions, lsTransition1.X2, lsTransition1.Y2, baseobjAngle2.X2, baseobjAngle2.Y2,
                                                ldThicknessJoint.X3, (thickness + transitionData.DimH) / 2, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            ((IDimensionText)ldVTransition1).Accuracy = ksAccuracyEnum.ksAccuracy1;
                                            ldVTransition1.Update();
                                            ILineDimension ldVTransition2 = LineDimension(lineDimensions, lsTransition2.X2, lsTransition2.Y2, baseobjAngle3.X2, baseobjAngle3.Y2,
                                                ldThicknessJoint.X3, -ldVTransition1.Y3, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            ((IDimensionText)ldVTransition2).Accuracy = ksAccuracyEnum.ksAccuracy1;
                                            ldVTransition2.Update();
                                            //Расчёты для угла
                                ...
                                case LocationPart.Верх_Право or LocationPart.Верх_Лево:
                                    {
                                        ...
                                        if (drawDimensions)
                                        {
                                            ...
                                            //Линейный горизонтальный перехода
                                            ILineDimension ldHTransition1 = LineDimension(lineDimensions, lsTransition1.X2, lsTransition1.Y2, baseobjAngle2.X2, baseobjAngle2.Y2,
                                                (thickness + transitionData.DimH) / 2, ldThicknessJoint.Y3, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                            ((IDimensionText)ldHTransition1).Accuracy = ksAccuracyEnum.ksAccuracy1;
                                            ldHTransition1.Update();
                                            ILineDimension ldHTransition2 = LineDimension(lineDimensions, lsTransition2.X2, lsTransition2.Y2, baseobjAngle3.X2, baseobjAngle3.Y2,
                                                -ldHTransition1.X3, ldThicknessJoint.Y3, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                            ((IDimensionText)ldHTransition2).Accuracy = ksAccuracyEnum.ksAccuracy1;
                                            ldHTransition2.Update();
                                            //Расчёты для угла
                                ...
                                case LocationPart.Лево_Верх:
                                    {
                                        ...
                                        if (drawDimensions)
                                        {
                                            ...
                                            ILineDimension ldThicknessJoint = LineDimension(lineDimensions, baseobjAngle2.X2, baseobjAngle2.Y2, baseobjAngle3.X2, baseobjAngle3.Y2,
                                                dtVParamA.X3 + gapDimToDim, 0, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            //Линейный вертикальный перехода
                                            LineDimension(lineDimensions, lsTransition1.X2, lsTransition1.Y2, baseobjAngle2.X2, baseobjAngle2.Y2,
                                                ldThicknessJoint.X3, (thickness + transitionData.DimH) / 2, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            //Расчёты для угла
                                ...
                                case LocationPart.Лево_Низ:
                                    {
                                        ...
                                        if (drawDimensions)
                                        {
                                            ...
                                            ILineDimension ldThicknessJoint = LineDimension(lineDimensions, baseobjAngle2.X2, baseobjAngle2.Y2, baseobjAngle3.X2, baseobjAngle3.Y2,
                                                dtVParamA.X3 + gapDimToDim, 0, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            //Линейный вертикальный перехода
                                            LineDimension(lineDimensions, lsTransition1.X2, lsTransition1.Y2, baseobjAngle3.X2, baseobjAngle3.Y2,
                                                ldThicknessJoint.X3, -(thickness + transitionData.DimH) / 2, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            //Расчёты для угла
                                ...
                                case LocationPart.Верх_Лево:
                                    {
                                        ...
                                        ILineSegment baseobjAngle3 = DrawLineSegment(lineSegments, baseobjAngle1.X1, baseobjAngle1.Y1, -baseobjAngle2.X2, baseobjAngle2.Y2);
                                        //Переход
                                        ILineSegment lsTransition1 = DrawLineSegment(lineSegments, baseobjAngle3.X2, baseobjAngle3.Y2, baseobjAngle3.X2 - transitionData.DimH, transitionData.DimL);
                                        //От угла к краю детали
                                        ILineSegment lsExtra1 = DrawLineSegment(lineSegments, lsTransition1.X2, lsTransition1.Y2, lsTransition1.X2, lsTransition1.Y2 + extraLength);
                                        ILineSegment lsExtra2 = DrawLineSegment(lineSegments, baseobjAngle2.X2, baseobjAngle2.Y2, baseobjAngle2.X2, lsExtra1.Y2);
                                        //Волнистая линия
                                        IWaveLines waveLines = symbols2DContainer.WaveLines;
                                        IWaveLine waveLine = waveLines.Add();
                                        waveLine.X1 = lsExtra1.X2;
                                        ...
                                        {
                                            DrawLineSegment(lineSegments, lsTransition1.X2, -ParamB, lsTransition1.X2, lsTransition1.Y2);
                                            DrawLineSegment(lineSegments, baseobjAngle2.X2, -ParamB, baseobjAngle2.X2, baseobjAngle2.Y2);
                                            DrawLineSegment(lineSegments, lsExtra2.X2, -ParamB, lsExtra1.X2, -ParamB);
                                        }
                                        //Чертим размеры
                                        if (drawDimensions)
                                        {
                                            ...
                                            //Линейный вертикальный угла
                                            ILineDimension dtHParamA = LineDimension(lineDimensions, baseobjAngle2.X1, baseobjAngle2.Y1, baseobjAngle2.X2, baseobjAngle2.Y2,
                                                baseobjAngle2.X2 + gapDimToPart * 2, xangle / 2, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            //Линейный вертикальный перехода
                                            ILineDimension ldTransition = LineDimension(lineDimensions, baseobjAngle3.X1, baseobjAngle3.Y1, lsTransition1.X2, lsTransition1.Y2, lsTransition1.X2 - gapDimToPart, transitionData.DimL / 2,
                                                ksLineDimensionOrientationEnum.ksLinDVertical);
                                            //Если угол равен 45 то оба размера угла делаем с десятыми
                                            if (ParamA == 45)
                                            {
                                            ...
                                            {
                                                //Зазора в стыке
                                                IDimensionText dtPatamB = (IDimensionText)LineDimension(lineDimensions, lsExtra1.X2, -ParamB, -baseobjAngle1.X2, baseobjAngle1.Y2,
                                                    ldTransition.X3, -ParamB - 1, ksLineDimensionOrientationEnum.ksLinDVertical);
                                                SetDeviation(dtPatamB, paramBTolerance);
                                                //Двигаем размер притупления и линейный угла на величину зазора если выбран разрез
                                                dtVParamA.Y3 -= ParamB;
                                                dtVParamA.Update();
                                            ...
                                            LineDimension(lineDimensions, lsTransition1.X2, lsTransition1.Y2, baseobjAngle3.X2, baseobjAngle3.Y2,
                                                -(thickness + transitionData.DimH) / 2, ldThicknessJoint.Y3, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                            //Расчёты для угла
                                            double r1 = (dtHParamA.X3 - ParamC / 2 + gapDimToDim * 0.5) / Math.Cos(ParamA * Math.PI / 180);
                                            double r2 = Math.Sqrt(Math.Pow((dtHParamA.X3 - ParamC / 2 + gapDimToDim * 0.5), 2) + Math.Pow(xangle / 2, 2));
                                            double angleDRadius = r1 > r2 ? r1 : r2;
                                            angleDRadius *= view.Scale;//Радиус будто бы должен задаваться в масштабе 1:1
                                            //Угол
                                            IDimensionText dtParamA = (IDimensionText)AngleDimension(angleDimensions, baseobjAngle1, baseobjAngle2, 10, xangle / 2, angleDRadius);
                                ...
                                case LocationPart.Низ_Лево:
                                    {
                                        ...
                                        if (!isCrossSection)
                                        {
                                            DrawLineSegment(lineSegments, lsTransition1.X2, ParamB, lsTransition1.X2, lsTransition1.Y2);
                                            DrawLineSegment(lineSegments, baseobjAngle2.X2, ParamB, baseobjAngle2.X2, baseobjAngle2.Y2);
                                            DrawLineSegment(lineSegments, baseobjAngle2.X2, ParamB, lsTransition1.X2, ParamB);
                                        }
                                        //Чертим размеры
                                        if (drawDimensions)
                                        {
                                            ...
                                            ILineDimension dtHParamA = LineDimension(lineDimensions, baseobjAngle2.X1, baseobjAngle2.Y1, baseobjAngle2.X2, baseobjAngle2.Y2,
                                                baseobjAngle2.X2 + gapDimToPart * 2, -xangle / 2, ksLineDimensionOrientationEnum.ksLinDVertical);
                                            //Линейный вертикальный перехода
                                            ILineDimension ldTransition = LineDimension(lineDimensions, lsTransition1.X2, lsTransition1.Y2, baseobjAngle3.X1, baseobjAngle3.Y1, lsTransition1.X2 - gapDimToPart, -transitionData.DimL / 2,
                                                ksLineDimensionOrientationEnum.ksLinDVertical);
                                            //Если угол равен 45 то оба размера угла делаем с десятыми
                                            if (ParamA == 45)
                                            {
                                            ...
                                            {
                                                //Зазора в стыке
                                                IDimensionText dtPatamB = (IDimensionText)LineDimension(lineDimensions, lsExtra1.X1, ParamB, baseobjAngle1.X1, baseobjAngle1.Y1,
                                                    ldTransition.X3, ParamB + 1, ksLineDimensionOrientationEnum.ksLinDVertical);
                                                SetDeviation(dtPatamB, paramBTolerance);
                                                //Двигаем размер притупления и линейный угла на величину зазора если выбран разрез
                                                dtVParamA.Y3 += ParamB;
