                    ...
                    switch (locationPart)
                    {
                        case LocationPart.Право_Верх or LocationPart.Право_Низ or LocationPart.Лево_Верх or LocationPart.Лево_Низ:
                            ...
                            if (drawDimensions)
                            {
                                ...
                                //Горизонтальный угла
                                LineDimension(lineDimensions, -xangle - ParamB / 2, -thickness / 2, -ParamB / 2, -ParamC / 2,
                                ...
                                ILineDimension ldParamB = LineDimension(lineDimensions, -ParamB / 2, -ParamC / 2, ParamB / 2, -ParamC / 2,
                                    ParamB / 2 + 1, -thickness / 2 - gapDimToPart * 2 - gapDimToDim, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                ...
                                {
                                    ldParamB.Y3 = -thickness / 2 - gapDimToPart * 2 - gapDimToDim;
                                }
                                else
                                {
                                    ldParamB.Y3 = -thickness / 2 - gapDimToPart * 2 - gapDimToDim * 1.5;
                                }
                                SetDeviation((IDimensionText)ldParamB, paramBTolerance);
                                //Линейный вертикальный притупления
                                ILineDimension ldParamCL = LineDimension(lineDimensions, -ParamB / 2, ParamC / 2, -ParamB / 2, -ParamC / 2,
                                    -xangle - extraLength - gapDimToPart - ParamB / 2, -ParamC / 2 -1, ksLineDimensionOrientationEnum.ksLinDVertical);
                                ...
                                ILineDimension ldThicknessR = LineDimension(lineDimensions, ParamB / 2 + xangle + extraLength, thickness / 2, ParamB / 2 + xangle + extraLength, -thickness / 2,
                                ...
                                {
                                    ldParamCR.X3 = xangle + extraLength + gapDimToPart * 3 + ParamB / 2;
                                    ldParamAHR.X3 = ldParamCR.X3;
                                    ldThicknessR.X3 = ldParamCR.X3 + gapDimToDim;
                                ...
                                ILineSegment baseobjAngle1 = DrawLineSegment(lineSegments, -ParamB / 2, ParamC / 2, -ParamB / 2 - xangle, thickness / 2);
                        ...
                        case LocationPart.Верх_Лево or LocationPart.Верх_Право or LocationPart.Низ_Лево or LocationPart.Низ_Право:
                            ...
                            switch (locationPart)
                            {
                                case LocationPart.Верх_Лево or LocationPart.Верх_Право:
                                    document2DAPI5.ksMoveObj(drawingGroup.Reference, 0, ParamB);
                                    break;
                            ...
                            {
                                case LocationPart.Верх_Лево or LocationPart.Верх_Право:
                                    document2DAPI5.ksMoveObj(drawingGroup.Reference, 0, -ParamB / 2);
                                    break;
                                case LocationPart.Низ_Лево or LocationPart.Низ_Право:
                                    document2DAPI5.ksMoveObj(drawingGroup.Reference, 0, ParamB / 2);
                                    break;
                            ...
                            if (drawDimensions)
                            {
                                ...
                                LineDimension(lineDimensions, -thickness / 2, xangle + ParamB / 2 , -ParamC / 2, ParamB / 2 ,
                                    ldParamA.X3, xangle / 2 + ParamB / 2, ksLineDimensionOrientationEnum.ksLinDVertical);
                                //Линейный вертикальный зазора в стыке
                                ILineDimension ldParamB = LineDimension(lineDimensions, -ParamC / 2, -ParamB / 2 , -ParamC / 2, ParamB / 2,
                                    ldParamA.X3 - gapDimToDim, ParamB / 2 + 1 , ksLineDimensionOrientationEnum.ksLinDVertical);
                                SetDeviation((IDimensionText)ldParamB, paramBTolerance);
                                ...
                                ILineDimension ldParamCH = LineDimension(lineDimensions, -ParamC / 2, ParamB / 2, ParamC / 2, ParamB / 2 ,
                                    ParamC / 2 + 1, xangle + extraLength + gapDimToPart + ParamB / 2 , ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                SetDeviation((IDimensionText)ldParamCH, paramCTolerance);
                                ILineDimension ldParamCD = LineDimension(lineDimensions, -ParamC / 2, -ParamB / 2, ParamC / 2, -ParamB / 2 ,
                                    ParamC / 2 + 1, -xangle - extraLength - gapDimToPart * 2 - ParamB / 2, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                //Линейный горизонтальный угла
                                ILineDimension ldParamAHH = LineDimension(lineDimensions, -thickness / 2, ParamB / 2 + xangle + extraLength, -ParamC / 2, ParamB / 2,
                                ...
                                ldParamAHH.Update();
                                ILineDimension ldParamAHD = LineDimension(lineDimensions, -thickness / 2, -ParamB / 2 - xangle - extraLength, -ParamC / 2, -ParamB / 2,
                                ...
                                ILineDimension ldThicknessH = LineDimension(lineDimensions, -thickness / 2, ParamB / 2 + xangle + extraLength, thickness / 2, ParamB / 2 + xangle + extraLength,
                                    0, ldParamCH.Y3 + gapDimToDim, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                ILineDimension ldThicknessD = LineDimension(lineDimensions, -thickness / 2, -ParamB / 2 - xangle - extraLength, thickness / 2, -ParamB / 2 - xangle - extraLength,
                                    0, ldParamCD.Y3 - gapDimToDim, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                //Если верхний и нижний допуск притупления одинаков то расстояние до детали меньше чем при разных допусках
                                if (Math.Abs(ParamCTolerance[0]) != Math.Abs(ParamCTolerance[1]))
                                {
                                    ldParamCD.Y3 = -xangle - extraLength - gapDimToPart * 3 - ParamB / 2;
                                    ldParamAHD.Y3 = ldParamCD.Y3;
                                    ldThicknessH.Y3 = ldParamCH.Y3 + gapDimToDim * 1.5;
                                    ldThicknessD.Y3 = ldParamCD.Y3 - gapDimToDim;
                                }
                                ldParamAHD.Update();
                                ldParamCD.Update();
                                ldThicknessD.Update();
                                ...
                                angleDRadius *= view.Scale;//Радиус будто бы должен задаваться в масштабе 1:1
                                //Линии нужны для построения размера угла
                                ILineSegment baseobjAngle1 = DrawLineSegment(lineSegments, ParamC / 2, -ParamB / 2, thickness / 2, -ParamB / 2 - xangle);
                    ...
                    switch (locationPart)
                    {
                        case LocationPart.Право_Верх or LocationPart.Право_Низ:
                            ...
                            if (drawDimensions)
                            {
                                //Размер скоса
                                double xangle = (thickness - ParamC) / 2 * Math.Tan(ParamA * Math.PI / 180);
                                double xangleExtraLength = extraLength + xangle;
                                extraLength += 10;
                                xangleExtraLength = xangleExtraLength < 1 ? 1 : xangleExtraLength;
                                //Линейный горизонтальный зазора в стыке
                                ILineDimension ldParamB = LineDimension(lineDimensions, -ParamB / 2, -thickness / 2, ParamB / 2, -ParamC / 2,
                                    -ParamB / 2 - 1, -thickness / 2 - gapDimToPart * 2, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                //Если верхний и нижний допуск зазора одинаков то расстояние до детали меньше чем при разных допусках
                                if (Math.Abs(ParamBTolerance[0]) == Math.Abs(ParamBTolerance[1]))
                                {
                                    ldParamB.Y3 = -thickness / 2 - gapDimToPart * 2;
                                }
                                else
                                {
                                ...
                                //Линейный вертикальный притупления                                
                                ILineDimension ldParamCR = LineDimension(lineDimensions, ParamB / 2, ParamC / 2, ParamB / 2, -ParamC / 2,
                                    xangle + xangleExtraLength + gapDimToPart * 2 + ParamB / 2, -ParamC / 2 - 1, ksLineDimensionOrientationEnum.ksLinDVertical);
                                //Линейный вертикальный угла
                                ILineDimension ldParamAHR = LineDimension(lineDimensions, ParamB / 2 + xangle + xangleExtraLength, thickness / 2, ParamB / 2, ParamC / 2,
                                    ldParamCR.X3, (thickness + ParamC) / 4, ksLineDimensionOrientationEnum.ksLinDVertical);
                                ((IDimensionText)ldParamAHR).Accuracy = ksAccuracyEnum.ksAccuracy1;
                                ldParamAHR.Update();
                                //Линейный вертикальный толщины
                                ILineDimension ldThicknessL = LineDimension(lineDimensions, -ParamB / 2 - extraLength, thickness / 2, -ParamB / 2 - extraLength, -thickness / 2,
                                    -ParamB / 2 - extraLength - gapDimToPart, 0, ksLineDimensionOrientationEnum.ksLinDVertical);
                                ILineDimension ldThicknessR = LineDimension(lineDimensions, ParamB / 2 + xangle + xangleExtraLength, thickness / 2, ParamB / 2 + xangle + xangleExtraLength, -thickness / 2,
                                    ldParamCR.X3 + gapDimToDim, 0, ksLineDimensionOrientationEnum.ksLinDVertical);
                                //Если верхний и нижний допуск притупления одинаков то расстояние до детали меньше чем при разных допусках
                                if (Math.Abs(ParamCTolerance[0]) != Math.Abs(ParamCTolerance[1]))
                                {
                                    ldParamCR.X3 = xangle + xangleExtraLength + gapDimToPart * 3 + ParamB / 2;
                                    ldParamAHR.X3 = ldParamCR.X3;
                                    ldThicknessR.X3 = ldParamCR.X3 + gapDimToDim;
                                }
                                ldParamCR.Update();
                                ...
                                IAngleDimension adParamA = AngleDimension(angleDimensions, baseobjAngle1, baseobjAngle2,
                                    ParamB / 2 + xangle / 2, (thickness - ParamC) / 2 + gapDimToPart * 2, angleDRadius);
                                SetDeviation((IDimensionText)adParamA, ParamATolerance);
                            }
                            break;
                        case LocationPart.Лево_Верх or LocationPart.Лево_Низ:
                            ...
                            if (drawDimensions)
                            {
                                ...
                                xangleExtraLength = xangleExtraLength < 1 ? 1 : xangleExtraLength;
                                //Линейный горизонтальный зазора в стыке
                                ILineDimension ldParamB = LineDimension(lineDimensions, -ParamB / 2, -ParamC / 2, ParamB / 2, -thickness / 2 ,
                                    ParamB / 2 + 1, -thickness / 2 - gapDimToPart * 2, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                //Если верхний и нижний допуск зазора одинаков то расстояние до детали меньше чем при разных допусках
                                if (Math.Abs(ParamBTolerance[0]) == Math.Abs(ParamBTolerance[1]))
                                {
                                ...
                                //Линейный вертикальный притупления                                
                                ILineDimension ldParamCL = LineDimension(lineDimensions, -ParamB / 2, ParamC / 2, -ParamB / 2, -ParamC / 2,
                                    -xangle - xangleExtraLength - gapDimToPart - ParamB / 2, -ParamC / 2 - 1, ksLineDimensionOrientationEnum.ksLinDVertical);
                                //Линейный вертикальный угла
                                ILineDimension ldParamAHL = LineDimension(lineDimensions, -ParamB / 2 - xangle - xangleExtraLength, thickness / 2, -ParamB / 2, ParamC / 2,
                                    ldParamCL.X3, (thickness + ParamC) / 4, ksLineDimensionOrientationEnum.ksLinDVertical);
                                ((IDimensionText)ldParamAHL).Accuracy = ksAccuracyEnum.ksAccuracy1;
                                ldParamAHL.Update();
                                //Линейный вертикальный толщины
                                ILineDimension ldThicknessR = LineDimension(lineDimensions, ParamB / 2 + extraLength, thickness / 2, ParamB / 2 + extraLength, -thickness / 2,
                                    ParamB / 2 + extraLength + gapDimToPart * 2, 0, ksLineDimensionOrientationEnum.ksLinDVertical);
                                ILineDimension ldThicknessL = LineDimension(lineDimensions, -ParamB / 2 - xangle - xangleExtraLength, thickness / 2, -ParamB / 2 - xangle - xangleExtraLength, -thickness / 2,
                                    ldParamCL.X3 - gapDimToDim, 0, ksLineDimensionOrientationEnum.ksLinDVertical);
                                //Если верхний и нижний допуск притупления одинаков то расстояние до детали меньше чем при разных допусках
                                if (Math.Abs(ParamCTolerance[0]) != Math.Abs(ParamCTolerance[1]))
                                {
                        ...
                        case LocationPart.Верх_Лево or LocationPart.Верх_Право:
                            ...
                            if (drawDimensions)
                            {
                                ...
                                //Линейный горизонтальный притупления
                                ILineDimension ldParamCH = LineDimension(lineDimensions, -ParamC / 2, ParamB / 2, ParamC / 2, ParamB / 2,
                                    ParamC / 2 + 1, xangle + xangleExtraLength + gapDimToPart + ParamB / 2, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                SetDeviation((IDimensionText)ldParamCH, paramCTolerance);
                                //Линейный горизонтальный угла
                                ILineDimension ldParamAHH = LineDimension(lineDimensions, -thickness / 2, ParamB / 2 + xangle + xangleExtraLength, -ParamC / 2, ParamB / 2,
                                    -(thickness + ParamC) / 4, ldParamCH.Y3, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                ((IDimensionText)ldParamAHH).Accuracy = ksAccuracyEnum.ksAccuracy1;
                                ldParamAHH.Update();
                                //Линейный горизонтальный толщины
                                ILineDimension ldThicknessH = LineDimension(lineDimensions, -thickness / 2, ParamB / 2 + xangle + xangleExtraLength, thickness / 2, ParamB / 2 + xangle + xangleExtraLength,
                                    0, ldParamCH.Y3 + gapDimToDim, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                ILineDimension ldThicknessD = LineDimension(lineDimensions, -thickness / 2, -ParamB / 2 - extraLength, thickness / 2, -ParamB / 2 - extraLength,
                                    0, -ParamB / 2 - extraLength - gapDimToPart * 2, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                //Если верхний и нижний допуск притупления одинаков то расстояние до детали меньше чем при разных допусках
                                if (Math.Abs(ParamCTolerance[0]) != Math.Abs(ParamCTolerance[1]))
                                {
                                    ldThicknessH.Y3 = ldParamCH.Y3 + gapDimToDim * 1.5;
                        ...
                        case LocationPart.Низ_Лево or LocationPart.Низ_Право:
                            ...
                            if (drawDimensions)
                            {
                                ...
                                //Линейный горизонтальный притупления
                                ILineDimension ldParamCD = LineDimension(lineDimensions, -ParamC / 2, -ParamB / 2, ParamC / 2, -ParamB / 2,
                                    ParamC / 2 + 1, -xangle - xangleExtraLength - gapDimToPart * 2 - ParamB / 2, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                SetDeviation((IDimensionText)ldParamCD, paramCTolerance);
                                //Линейный горизонтальный угла
                                ILineDimension ldParamAHD = LineDimension(lineDimensions, -thickness / 2, -ParamB / 2 - xangle - xangleExtraLength, -ParamC / 2, -ParamB / 2,
                                    -(thickness + ParamC) / 4, ldParamCD.Y3, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                ((IDimensionText)ldParamAHD).Accuracy = ksAccuracyEnum.ksAccuracy1;
                                ldParamAHD.Update();
                                //Линейный горизонтальный толщины
                                ILineDimension ldThicknessH = LineDimension(lineDimensions, -thickness / 2, ParamB / 2 + extraLength, thickness / 2, ParamB / 2 + extraLength,
                                    0, ParamB / 2 + extraLength + gapDimToPart, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                ILineDimension ldThicknessD = LineDimension(lineDimensions, -thickness / 2, -ParamB / 2 - xangle - xangleExtraLength, thickness / 2, -ParamB / 2 - xangle - xangleExtraLength,
                                    0, ldParamCD.Y3 - gapDimToDim, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                //Если верхний и нижний допуск притупления одинаков то расстояние до детали меньше чем при разных допусках
                                if (Math.Abs(ParamCTolerance[0]) != Math.Abs(ParamCTolerance[1]))
                                {
                                    ldParamCD.Y3 = -xangle - xangleExtraLength - gapDimToPart * 3 - ParamB / 2;
                                    ldParamCD.Update();
                                    ldParamAHD.Y3 = ldParamCD.Y3;
                                    ldParamAHD.Update();
                                    ldThicknessD.Y3 = ldParamCD.Y3 - gapDimToDim;
                    ...
                    switch (locationPart)
                    {
                        case LocationPart.Право_Верх or LocationPart.Лево_Верх:
                            ...
                            if (drawDimensions)
                            {
                                ...
                                extraLength = extraLength < 1 ? 1 : extraLength;
                                //Горизонтальный угла
                                ILineDimension ldParamAL = LineDimension(lineDimensions, -xangle - ParamB / 2, thickness, -ParamB / 2, ParamC,
                                    -xangle / 2 - ParamB / 2, thickness + gapDimToPart, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                LineDimension(lineDimensions, xangle + ParamB / 2, thickness, ParamB / 2, ParamC,
                                    xangle / 2 + ParamB / 2, ldParamAL.Y3, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                //Линейный горизонтальный зазора в стыке
                                ILineDimension ldParamB = LineDimension(lineDimensions, -ParamB / 2, ParamC, ParamB / 2, ParamC,
                                    ParamB / 2 + 1, ldParamAL.Y3 + gapDimToDim, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                SetDeviation((IDimensionText)ldParamB, paramBTolerance);
                                //Линейный вертикальный притупления
                                ILineDimension ldParamCR = LineDimension(lineDimensions, ParamB / 2, ParamC, ParamB / 2, 0,
                                    -gapDimToPart - ParamB / 2, -ParamC - 1, ksLineDimensionOrientationEnum.ksLinDVertical);
                                SetDeviation((IDimensionText)ldParamCR, paramCTolerance);
                                //Линейный вертикальный толщины
                                ILineDimension ldThicknessL = LineDimension(lineDimensions, -ParamB / 2 - xangle - extraLength, thickness, -ParamB / 2 - xangle - extraLength, 0,
                                ...
                                angleDRadius *= view.Scale;//Радиус будто бы должен задаваться в масштабе 1:1
                                //Линии нужны для построения размера угла
                                ILineSegment baseobjAngle1 = DrawLineSegment(lineSegments, -ParamB / 2, ParamC, -ParamB / 2 - xangle, thickness);
                        ...
                        case LocationPart.Верх_Право or LocationPart.Низ_Право:
                            ...
                            if (drawDimensions)
                            {
                                ...
                                extraLength = extraLength < 1 ? 1 : extraLength;
                                //Вертикальный угла
                                ILineDimension ldParamAH = LineDimension(lineDimensions, thickness, xangle + ParamB / 2 , ParamC, ParamB / 2 ,
                                    thickness + gapDimToPart * 2, xangle / 2 + ParamB / 2 , ksLineDimensionOrientationEnum.ksLinDVertical);
                                LineDimension(lineDimensions, thickness, -xangle - ParamB / 2 , ParamC, -ParamB / 2 ,
                                    ldParamAH.X3, -xangle / 2 - ParamB / 2, ksLineDimensionOrientationEnum.ksLinDVertical);
                                //Линейный вертикальный зазора в стыке
                                ILineDimension ldParamB = LineDimension(lineDimensions, ParamC, -ParamB / 2 , ParamC, ParamB / 2,
                                    ldParamAH.X3 + gapDimToDim, ParamB / 2 + 1, ksLineDimensionOrientationEnum.ksLinDVertical);
                                SetDeviation((IDimensionText)ldParamB, paramBTolerance);
                                if (Math.Abs(ParamBTolerance[0]) != Math.Abs(ParamBTolerance[1]))
                                {
                                ...
                                //Линейный горизонтальный притупления
                                ILineDimension ldParamCR = LineDimension(lineDimensions, 0, -ParamB / 2 , ParamC, -ParamB / 2,
                                    -ParamC - 1, gapDimToPart + ParamB / 2, ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                SetDeviation((IDimensionText)ldParamCR, paramCTolerance);
                                //Линейный горизонтальный толщины
                                ILineDimension ldThicknessD = LineDimension(lineDimensions, thickness, -ParamB / 2 - xangle - extraLength , 0, -ParamB / 2 - xangle - extraLength,
                                    thickness / 2, -ParamB / 2 - xangle - extraLength - gapDimToPart * 2 , ksLineDimensionOrientationEnum.ksLinDHorizontal);
                                ILineDimension ldThicknessH = LineDimension(lineDimensions, thickness, ParamB / 2 + xangle + extraLength , 0, ParamB / 2 + xangle + extraLength,
                                ...
                                angleDRadius *= view.Scale;//Радиус будто бы должен задаваться в масштабе 1:1
                                //Линии нужны для построения размера угла
                                ILineSegment baseobjAngle1 = DrawLineSegment(lineSegments, ParamC, -ParamB / 2 , thickness, -ParamB / 2 - xangle );
                        ...
                        case LocationPart.Лево_Верх or LocationPart.Лево_Низ:
                            {
                                ...
                                {
                                    //Линейный вертикальный толщины
                                    LineDimension(lineDimensions, -extraLength, -thickness / 2, -extraLength, thickness / 2, -extraLength - gapDimToPartLeft,
